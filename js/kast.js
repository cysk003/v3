...
(function ($, window, document, undefined) {
    ...
    function Plugin(element, options) {
        ...
        this.hostCORS = [
            ...
            'https://https://plugstream.herokuapp.com/' + this.host,
        ...
        artwork: function (artist, track, callback) {
            ...
            var artistC = chaRe(artist),
                ...
                ajaxArtwork = function (artistN, trackN, noLuck) {
                    ...
                    var url = "https://itunes.apple.com/search?term==" + artistN + "-" + trackN + "&media=music&limit=1";
                    
                    
                    //var spotifyTrackAPI = 'https://api.miradio.pro/musicsearch?query=artist:' + artistN + '%20track:' + trackN + '&limit=1&type=track',
                        //spotifyArtistAPI = 'https://api.miradio.pro/musicsearch?query=artist:' + artistN + '&limit=1&type=artist',
